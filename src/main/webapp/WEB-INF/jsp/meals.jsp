    ...
    <div class="container">
        ...
        <div class="card border-dark">
            <div class="card-body pb-0">
                <form id="form" method="get" action="meals/filter">
                    <div class="row">
                        <div class="col-2">
                        ...
                        <div class="col-3">
                            ...
                            <input class="form-control" id="endTime" type="text" name="endTime"
                                   value="${param.endTime}" autocomplete="off">
                        </div>
                    </div>
                </form>
            </div>
            ...
            <div class="modal-body">
                <form id="detailsForm">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="dateTime" name="dateTime" value="${fn:formatDateTime(meal.dateTime)}"
